...
const iconUrls = iconSlugs.map((slug) => `https://cdn.simpleicons.org/${slug}`)
const workflowSteps = [
  'Map the workflow',
  'Choose the stack',
  'Build the API',
            ...
            <div className="mt-2 grid gap-2">
              ...
              <div className="grid gap-2">
                {workflowSteps.map((step, index) => (
                  <div key={step} className="flex items-center gap-3 rounded-full border border-border-dim/80 bg-bg/45 px-3 py-2 font-mono text-xs text-muted">
