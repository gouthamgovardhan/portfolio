...
export const PERSONAL = {
  ...
  lastName: 'Reddy',
  suffixName: 'S.',
  tagline: 'AI Engineer building scalable LLM systems',
  eyebrow: 'AI Engineer · Bengaluru',
  heroHeadline: 'I build production AI systems with RAG, agents, and scalable APIs.',
  heroDescription:
    'Focused on conversational AI, decision automation, prompt engineering, and reliable backend delivery.',
  bio: [
    'AI Engineer from Bengaluru focused on LLM applications, RAG, agentic workflows, and production automation.',
    'I build systems that understand context, recommend actions, integrate with APIs, and reduce manual work in real business workflows.',
  ],
  highlightPoints: [
    'Built LLM and agentic AI workflows supporting 1000+ enterprise users',
    'Reduced manual effort and response time by up to 70% through automation',
    'Developed conversational AI for query handling, context capture, and routing',
    'Designed RAG pipelines with OpenAI, Grok, and Perplexity evaluation',
    'Built REST API integrations and scalable backend automation',
    'Mentored 4 developers and supported production issue resolution',
  ],
  ...
  currentRole: 'AI Engineer · LLM Systems & Automation',
...
export const HERO_TERMINAL: TerminalLine[] = [
  ...
  { label: 'retrieval', value: 'RAG + multi-model evaluation' },
  { label: 'automation', value: 'context-aware decisions' },
  { label: 'backend', value: 'scalable APIs' },
]
...
export const ROLE_PATHS: RolePath[] = [
  {
    ...
    proof: 'Production LLM workflows supporting 1000+ enterprise users',
...
export const STATS: StatItem[] = [
  ...
  { value: '4', suffix: '', label: 'Developers Mentored', detail: 'Supported architecture, debugging, and code review' },
]
...
export const EXPERIENCE: ExperienceItem[] = [
  {
    ...
    current: true,
    bullets: [
      'Built LLM-powered and agentic AI workflows supporting 1000+ enterprise users',
      'Reduced manual effort and response time by up to 70% through automation',
      'Developed conversational AI for query handling, context capture, and intelligent routing',
      'Designed RAG pipelines with evaluation across OpenAI, Grok, and Perplexity',
      'Integrated REST APIs and built scalable backend automation',
      'Mentored 4 developers and supported architecture and production issue resolution',
    ],
    tags: ['LLM', 'RAG', 'Agentic AI', 'Python', 'REST APIs', 'FastAPI'],
  },
  {
    company: 'Visionet Systems Inc.',
...
export const PROJECTS: ProjectItem[] = [
  {
    title: 'Salesforce Service Operations',
    description:
      'My contribution focused on Salesforce service operations, access configuration, workflow support, and production troubleshooting.',
    icon: 'SO',
    category: 'Salesforce Service',
    accent: 'cyan',
    tags: ['Service Cloud', 'SOQL', 'Email-to-Case', 'Omni-Channel'],
    highlights: [
      'Worked with profiles, permission sets, queues, and access configuration',
      'Investigated production issues using SOQL and root cause analysis',
      'Supported case workflows, Email-to-Case, Omni-Channel, reports, and dashboards',
    ],
    outcome: 'Hands-on Salesforce service support, configuration, troubleshooting, and workflow ownership.',
    architecture: ['Access configuration', 'Service workflows', 'SOQL troubleshooting', 'Release support'],
  ...
  },
  {
    ...
    description:
      'My contribution focused on Salesforce development, automation, testing, documentation, and release support.',
    icon: 'SD',
    ...
    highlights: [
      ...
      'Built Salesforce Flows for business-process automation',
      'Prepared technical documentation and supported testing and releases',
    ],
    outcome: 'Hands-on platform development across Apex, LWC, Flow, testing, and deployment support.',
    architecture: ['Requirements', 'Apex and LWC', 'Flow automation', 'Testing and release'],
    proofStatus: 'Professional experience',
    disclaimer: 'Client, company, and internal project details are intentionally omitted.',
    featured: true,
  },
  {
    ...
    description:
      'My contribution focused on Agentforce use cases, prompt configuration, conversational experiences, and service automation.',
    icon: 'AF',
    category: 'Salesforce AI',
    accent: 'rose',
    tags: ['Agentforce', 'Prompt Builder', 'Einstein Bots', 'Service Cloud'],
    highlights: [
      'Explored Agentforce use cases for service workflow automation',
      'Configured Prompt Builder for guided AI responses',
      'Built conversational flows using Einstein Bots and Salesforce automation',
    ],
    outcome: 'Hands-on work connecting Salesforce AI capabilities with practical service workflows.',
    architecture: ['Use-case design', 'Prompt Builder', 'Conversational flow', 'Service automation'],
    proofStatus: 'Professional experience',
    disclaimer: 'Client, company, and internal project details are intentionally omitted.',
    featured: false,
  },
  {
    title: 'Salesforce Sustainability Configuration',
    description:
      'My contribution focused on Salesforce sustainability configuration, data modeling, reporting, and solution presentation.',
    icon: 'NZ',
    category: 'Salesforce Cloud',
    accent: 'emerald',
    tags: ['Net Zero Cloud', 'Reports & Dashboards', 'Data Modeling', 'Salesforce'],
    highlights: [
      'Configured Net Zero Cloud features for sustainability tracking',
      'Worked on data models, reports, and dashboards',
      'Presented the solution and explained the technical approach',
    ],
    outcome: 'Hands-on configuration, data modeling, reporting, and technical communication.',
    architecture: ['Configuration', 'Data modeling', 'Reports and dashboards', 'Presentation'],
    proofStatus: 'Professional experience',
    disclaimer: 'Client, company, and internal project details are intentionally omitted.',
    featured: false,
  },
